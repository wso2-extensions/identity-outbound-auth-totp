...
//        }
        body = body + "</div></td></tr>";
            ...
            body = body + "<tr><td><label class=\"control-label\">Refresh Secret Key</label></td><td><div class=\"controls\">";
              body = body + "<a style=\"margin-right: 33%;\" onclick=\"validateRefreshSecret();\">Click</a></div></td></tr>";
              body = body + "<tr><td><label class=\"control-label\">Enable TOTP</label></td><td><div class=\"controls\">";
              if (totpEnabled != ""){
